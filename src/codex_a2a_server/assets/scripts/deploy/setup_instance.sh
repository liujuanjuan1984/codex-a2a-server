...
: "${A2A_INTERRUPT_REQUEST_TTL_SECONDS:=3600}"
...
a2a_env_tmp="$(mktemp)"
{
  ...
  echo "A2A_ENABLE_HEALTH_ENDPOINT=${A2A_ENABLE_HEALTH_ENDPOINT}"
  echo "A2A_ENABLE_SESSION_SHELL=${A2A_ENABLE_SESSION_SHELL}"
  echo "A2A_INTERRUPT_REQUEST_TTL_SECONDS=${A2A_INTERRUPT_REQUEST_TTL_SECONDS}"
